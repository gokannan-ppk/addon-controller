...
const (
	...
	// CollectionFormatCSV comma separated values `addon,bar`
	CollectionFormatCSV = CollectionFormat("csv")

	// CollectionFormatSSV space separated values `addon bar`
	CollectionFormatSSV = CollectionFormat("ssv")

	// CollectionFormatTSV tab separated values `addon\tbar`
	CollectionFormatTSV = CollectionFormat("tsv")

	// CollectionFormatPipes pipe separated values `addon|bar`
	...
	// instance `addon=bar&addon=baz`. This is valid only for QueryParameters and FormParameters
