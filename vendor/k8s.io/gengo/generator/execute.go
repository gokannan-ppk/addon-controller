...
func (c *Context) ExecutePackage(outDir string, p Package) error {
	...
	// package is github.com/addon/bar, outDir=., p.Path()=github.com/addon/bar/generated,
	// then we really want to be writing files to ./generated, not ./github.com/addon/bar/generated.
	// The following will trim a path prefix (github.com/addon/bar) from p.Path() to arrive at
