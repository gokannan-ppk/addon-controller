...
type APIResource struct {
	...
	// kind is the kind for the resource (e.g. 'Addon' is the kind for a resource 'addon')
...
//	    // Represents the observations of a addon's current state.
...
type Condition struct {
	// type of condition in CamelCase or in addon.example.com/CamelCase.
	// ---
