...
var map_APIResource = map[string]string{
	...
	"kind":               "kind is the kind for the resource (e.g. 'Addon' is the kind for a resource 'addon')",
...
var map_Condition = map[string]string{
	...
	"type":               "type of condition in CamelCase or in addon.example.com/CamelCase.",
