...
type Descriptor interface {
	...
	// field "addon_field" in message "proto.package.MyMessage" is
	// uniquely identified as "proto.package.MyMessage.addon_field".
...
//	}
//	message BarMessage {
//		extends AddonMessage { optional BarMessage bar_field = 100; }
//	}
//
// Field "bar_field" is an extension of AddonMessage, but its full name is
// "example.BarMessage.bar_field" instead of "example.AddonMessage.bar_field".
