...
// For example, VendorlessPath("addon/bar/vendor/a/b") returns "a/b".
...
func pkgIsCandidate(filename string, refs references, pkg *pkg) bool {
	...
	// "go-addon" being package "addon", or "pkg.v3" being "pkg",
	// or directory "google.golang.org/api/cloudbilling/v1"
	// being package "cloudbilling", but doesn't
	// permit a directory "addon" to be package
...
func canUse(filename, dir string) bool {
	...
	// can contain ../vendor or ../internal but not ../addon/vendor or ../addon/internal
