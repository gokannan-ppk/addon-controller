...
import (
	...
	scheme "github.com/gokannan-ppk/addon-controller/pkg/generated/clientset/versioned/scheme"
...
func newAddons(c *AddoncontrollerV1alpha1Client, namespace string) *addons {
	return &addons{
		client: c.RESTClient(),
		ns:     namespace,
	}
